...
class Routes(
  ...
  def documentation = List(
    ...
    ("""GET""", this.prefix + (if(this.prefix.endsWith("/")) "" else "/") + """withAuthentication""", """controllers.HomeController.indexWithAuthentication"""),
  ...
  // @LINE:7
  private[this] lazy val controllers_HomeController_indexWithAuthentication1_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("withAuthentication")))
  )
  private[this] lazy val controllers_HomeController_indexWithAuthentication1_invoker = createInvoker(
    HomeController_0.indexWithAuthentication,
    HandlerDef(this.getClass.getClassLoader,
      "router",
      "controllers.HomeController",
      "indexWithAuthentication",
      Nil,
      "GET",
      """""",
      this.prefix + """withAuthentication"""
    )
  )
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    // @LINE:7
    case controllers_HomeController_indexWithAuthentication1_route(params) =>
      call { 
        controllers_HomeController_indexWithAuthentication1_invoker.call(HomeController_0.indexWithAuthentication)
      }
